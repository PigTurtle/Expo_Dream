...
const Box = (props) => {
    ...
    const gestureHandler = useAnimatedGestureHandler( {
        ...
        onEnd: (event, ctx) => {
            scale.value = repeat(sequence(withTiming(1.1, {duration: 200}), withTiming(1.0, {duration: 200}), withTiming(0.9, {duration: 100}), withTiming(1.0, {duration: 100})), -1);
        }
    });
...
export class ReanimatedScreen extends Component  {
    constructor(props) {
        super(props);        
