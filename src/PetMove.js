...
const Pet = (props) => {
    ...
    const [active, setActive] = useState(props.move);
    ...
    const react = (myactive) => {
        ...
        // 랜덤 패턴
        let pattern = Math.floor(Math.random()*10) % 2;
...
export class PetMove extends React.Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return (
            <View>
                <Pet petnum={this.props.petnum} move={this.props.move} />
            </View>
        );
    }
}
